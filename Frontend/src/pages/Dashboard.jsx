...
export default function MarketDashboard() {
    ...
    return (
        <div className="relative flex justify-center items-center min-h-screen p-4 overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
            {/* Background glow */}
            ...
            <div className="relative w-full max-w-7xl backdrop-blur-xl bg-white/40 dark:bg-gray-800/40 border border-white/30 rounded-2xl shadow-2xl p-6 sm:p-10 animate-fadeIn">
                ...
                <div className="mb-8 flex justify-center">
                    <input
                        ...
                        className="w-full max-w-md px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white/70 dark:bg-gray-700/70 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition"
                        value={searchTerm}
                ...
                {loading ? (
                    ...
                    <div className="overflow-x-auto rounded-lg border border-white/20 shadow-lg">
                        <table className="min-w-full text-sm text-left backdrop-blur-sm table-auto">
                            <thead className="bg-white/40 dark:bg-gray-700/40 border-b border-white/20">
                                <tr>
                                    {["S.no", "Coin", "Price (USD)", "24h Change", "Market Cap"].map((heading) => (
                                        <th
                                            key={heading}
                                            className="px-5 py-4 text-left text-gray-700 dark:text-gray-300 font-semibold tracking-wide"
                                        >
                                            {heading}
                                        </th>
                                    ))}
                                ...
                                {filteredCurrencies.length === 0 ? (
                                    ...
                                    filteredCurrencies.map((coin, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-5 py-3 whitespace-nowrap text-gray-900 dark:text-gray-100">
                                                ${coin.current_price.toLocaleString()}
                                            </td>
                                            <td
                                                className={`px-5 py-3 whitespace-nowrap font-semibold ${coin.price_change_percentage_24h >= 0
