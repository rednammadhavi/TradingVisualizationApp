...
export default function CryptoProfile() {
    ...
    return (
        <div className="relative flex justify-center items-center min-h-[90vh] px-4 overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
            ...
            {/* Card */}
            <div className="relative w-full max-w-3xl backdrop-blur-xl bg-white/40 dark:bg-gray-800/40 border border-white/30 rounded-2xl shadow-2xl p-8 animate-fadeIn">
                {/* Header Section */}
                <div className="flex items-center gap-6 border-b border-white/30 pb-6">
                    <img
                        src={data.image.large}
                        alt={data.name}
                        className="w-24 h-24 rounded-full border border-white/40 shadow-lg"
                    />
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300 uppercase tracking-wider">
                            {data.symbol}
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div className="bg-white/60 dark:bg-gray-700/60 p-4 rounded-lg border border-white/30 shadow">
                ...
                <div className="mt-8">
                    ...
                    <p
                        className="text-gray-700 dark:text-gray-300 mt-3 text-sm leading-relaxed"
                ...
                <button
                    ...
                    className="mt-8 w-full py-3 rounded-lg bg-gradient-to-r from-blue-600 to-purple-500 text-white font-semibold shadow-lg hover:scale-105 hover:shadow-purple-500/50 transition-all duration-300"
                >
                    Add to Watchlist
                </button>
            </div>
